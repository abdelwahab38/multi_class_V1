...
from model_load_data import make_dataloaders #MultiClassDataset,
...
def validate_epoch(epoch,train_loader,val_loader,device):
    ...
    class_iou, mean_iou = eval_net_loader(net, val_loader, 8, device)
...
def train_net(train_loader, val_loader, net, device, epochs=200, batch_size=4, lr=0.0001, save_cp=True):
...
if __name__ == '__main__':
    ...
    dir_data = "C:\\Users\\ABDEL\\Downloads\\unet-multiclass-pytorch-master\\unet-multiclass-pytorch-master\\data\\images_train"
    ...
    checkpoint_path = "C:\\Users\ABDEL\\Downloads\\unet-multiclass-pytorch-master\\unet-multiclass-pytorch-master\\checkpoint\\checkpoint.pth"
    ...
    try:
        train_net(train_loader, val_loader, net, device, epochs=200, batch_size=4, lr=0.0001)
        
    except KeyboardInterrupt:
        torch.save(net.state_dict(), 'C:\\Users\ABDEL\\Downloads\\unet-multiclass-pytorch-master\\unet-multiclass-pytorch-master\\checkpoint\\INTERRUPTED.pth')
