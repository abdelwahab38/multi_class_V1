...
def get_args():
    ...
    parser = OptionParser()
    parser.add_option('-d', '--dir', dest='dir', default='C:/Users/ABDEL/Downloads/unet-multiclass-pytorch-master/unet-multiclass-pytorch-master/checkpoint', help='checkpoints directory')
